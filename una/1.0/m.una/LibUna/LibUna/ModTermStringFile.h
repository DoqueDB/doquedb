...
// 
#ifndef __ModTermStringFile_H__
#define __ModTermStringFile_H__

#include "ModVector.h"
#include "ModHashMap.h"
#include "LibUna/ModTermElement.h"  // ModTermType
...
public:
  ...
  // 検索関数
  ModBoolean isFound(const ModUnicodeString& _string)
