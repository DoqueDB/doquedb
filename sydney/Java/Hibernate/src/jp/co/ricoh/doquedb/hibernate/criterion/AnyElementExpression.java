 ...
 */
public class AnyElementExpression implements Criterion
{
	/** プロパティー名 */
	 ...
	 */
	protected AnyElementExpression(String propertyName, Object value, String op)
	{
		...
		throws HibernateException
	{
		...
		return new TypedValue[] {
			new TypedValue(col.getElementType(), value, EntityMode.POJO) };
	}
	...
	/** 一致条件を得る */
	protected final String getOp() { return op; }
}
