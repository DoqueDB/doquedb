...
//
//	FUNCTION public
//	Exception::UserLevel::UserLevel -- コンストラクタ(1)
//
//	NOTES
//	コンストラクタ。
//
...
//
//	FUNCTION public
//	Exception::UserLevel::UserLevel -- コンストラクタ(2)
//
//	NOTES
//	コンストラクタ。
//
...
//	なし
//
UserLevel::UserLevel(ErrorNumber::Type uiErrorNumber_)
...
//
//	FUNCTION public
//	Exception::UserLevel::UserLevel -- コンストラクタ(3)
//
//	NOTES
...
//	なし
//
UserLevel::UserLevel(unsigned int uiErrorNumber_,
					 const char* pszModuleName_,
					 const char* pszFileName_,
					 int iLineNumber_,
					 const char* pszStateCode_)
...
//
//	FUNCTION public
//	Exception::UserLevel::UserLevel -- コンストラクタ(4)
//
//	NOTES
//	コンストラクタ。引数をデータメンバーに設定する。
//
...
//
//	FUNCTION public
//	Exception::UserLevel::UserLevel -- コピーコンストラクタ
//
//	NOTES
//
//	ARGUMENTS
...
//	EXCEPTIONS
//
UserLevel::UserLevel(const Exception::Object& cObject_,
					 const char* pszStateCode_)
