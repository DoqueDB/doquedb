...
#ifndef __TRMEISTER_EXCEPTION_USERLEVEL_H
#define __TRMEISTER_EXCEPTION_USERLEVEL_H
...
//
//	CLASS
//	UserLevel -- ユーザレベルの例外をあらわすクラス
//
//	NOTES
//
class SYD_EXCEPTION_FUNCTION UserLevel : public Object
{
public:
	//コンストラクタ(1)
	UserLevel();
	//コンストラクタ(2)
	UserLevel(ErrorNumber::Type uiErrorNumber_);		//エラー番号
	//コンストラクタ(3)
	UserLevel(ErrorNumber::Type uiErrorNumber_,			//エラー番号
	...
	//コピーコンストラクタ
	UserLevel(const Object& cObject_,
			  const char* pszStateCode_);				//SQLSTATEコード
...
#endif //__TRMEISTER_EXCEPTION_USERLEVEL_H
//
//	Copyright (c) 2005, 2007, 2023 Ricoh Company, Ltd.
//	All rights reserved.
//
