...
// vi:set ts=4 sw=4:
//
// IntegerData.h -- 32 ビット長整数型データ関連のクラス定義、関数宣言
// 
...
#ifndef __TRMEISTER_COMMON_INTEGERDATA_H
#define __TRMEISTER_COMMON_INTEGERDATA_H
...
//	CLASS
//	Common::IntegerData -- 32 ビット長の整数型のデータを表すクラス
//
//	NOTES

class SYD_COMMON_FUNCTION IntegerData
	: public	ScalarData
{
public:
	//コンストラクタ(1)
	IntegerData();
	//コンストラクタ(2)
	explicit IntegerData(int iValue_);
	//デストラクタ
	virtual ~IntegerData();
...
#endif // __TRMEISTER_COMMON_INTEGERDATA_H
