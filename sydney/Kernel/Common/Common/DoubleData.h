...
// vi:set ts=4 sw=4:
//
// DoubleData.h -- 倍精度浮動小数点数型データ関連のクラス定義、関数宣言
// 
...
#ifndef __TRMEISTER_COMMON_DOUBLEDATA_H
#define __TRMEISTER_COMMON_DOUBLEDATA_H
...
//	CLASS
//	Common::DoubleData -- 倍精度浮動小数点数型のデータを表すクラス
//
//	NOTES

class SYD_COMMON_FUNCTION DoubleData
	: public	ScalarData
{
public:
	//コンストラクタ
	DoubleData();
	//コンストラクタ
	explicit DoubleData(double dValue_);
	//デストラクタ
	virtual ~DoubleData();
...
#endif // __TRMEISTER_COMMON_DOUBLEDATA_H
