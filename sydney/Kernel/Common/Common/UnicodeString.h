...
// vi:set ts=4 sw=4:
//
// Unicodestring.h -- UNICODE 関連のクラス定義、関数宣言
// 
...
#ifndef __TRMEISTER_COMMON_UNICODESTRING_H
#define __TRMEISTER_COMMON_UNICODESTRING_H
...
namespace UnicodeString
{
	...
	SYD_COMMON_FUNCTION
	int
	compare(const ModUnicodeChar* l, const ModUnicodeChar* r);
}
#endif

//	CONST
//	Common::LiteralCode -- ソースコード中の文字列リテラルの文字コード
//
//	NOTES

const ModKanjiCode::KanjiCodeType	LiteralCode = ModKanjiCode::utf8;

_TRMEISTER_COMMON_END

//	MACRO
//	_TRMEISTER_U_STRING --
//		ソースコードの文字コードの char* を ModUnicodeString に変換する
//
//	NOTES

#define	_TRMEISTER_U_STRING(s)	ModUnicodeString(s, Common::LiteralCode)

_TRMEISTER_END

#endif // __TRMEISTER_COMMON_UNICODESTRING_H
