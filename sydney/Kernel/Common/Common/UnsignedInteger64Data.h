...
// vi:set ts=4 sw=4:
//
// UnsignedInteger64Data.h --	64 ビット長非負整数型データ関連の
//								クラス定義、関数宣言
// 
...
#ifndef __TRMEISTER_COMMON_UNSIGNEDINTEGER64DATA_H
#define __TRMEISTER_COMMON_UNSIGNEDINTEGER64DATA_H
...
//	CLASS
//	Common::UnsignedInteger64Data -- 64 ビット長の非負整数型データを表すクラス
//
//	NOTES

class SYD_COMMON_FUNCTION UnsignedInteger64Data
	: public	ScalarData
{
public:
	//コンストラクタ(1)
	...
	//コンストラクタ(2)
	explicit UnsignedInteger64Data(ModUInt64 ullValue_);
	//デストラクタ
	virtual ~UnsignedInteger64Data();
...
#endif // __TRMEISTER_COMMON_UNSIGNEDINTEGER64DATA_H
