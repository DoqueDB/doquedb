...
// vi:set ts=4 sw=4:
//
// List.h --	トランザクション記述子を管理するための
//				侵入型リスト関連のテンプレートクラス定義、関数宣言
// 
// Copyright (c) 2000, 2013, 2014, 2023 Ricoh Company, Ltd.
// 
...
#ifndef	__SYDNEY_TRANS_LIST_H
#define	__SYDNEY_TRANS_LIST_H
...
public:
	...
	// サイズを得る
	typename Common::DoubleLinkedList<T>::Size getSizeWithLatch() const
	{
