/*
 * Makefile.c --- Kernel/Plan/Order/c
 * 
...
HDRS = \
	...
	$(LOCAL_EXPORT_HDRS)				\
	$(HDRDIR)/CheckedKey.h				\
	$(HDRDIR)/CheckedSpecification.h	\
	$(HDRDIR)/ChosenSpecification.h		\
	$(HDRDIR)/GeneratedSpecification.h
...
OBJS = \
	$(MESSAGE_OBJS)				\
	CheckedKey$O				\
	CheckedSpecification$O		\
	ChosenSpecification$O		\
	GeneratedSpecification$O	\
	Key$O						\
	Specification$O
