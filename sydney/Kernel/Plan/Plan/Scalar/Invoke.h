...
#ifndef __SYDNEY_PLAN_SCALAR_INVOKE_H
#define __SYDNEY_PLAN_SCALAR_INVOKE_H
...
////////////////////////////////////
//	CLASS
//	Plan::Scalar::Invoke -- Interface for invoke
//
//	NOTES
...
protected:
	...
	Invoke()
		: Super()
	{}
	Invoke(Tree::Node::Type eOperator_,
		   const STRING& cstrName_)
...
#endif // __SYDNEY_PLAN_SCALAR_INVOKE_H
