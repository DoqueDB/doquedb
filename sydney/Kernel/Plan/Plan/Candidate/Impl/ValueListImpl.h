...
// vi:set ts=4 sw=4:
//
// Candidate/Impl/ValueListImpl.h --
// 
...
#ifndef __SYDNEY_PLAN_CANDIDATE_IMPL_VALUELISTIMPL_H
#define __SYDNEY_PLAN_CANDIDATE_IMPL_VALUELISTIMPL_H
...
namespace Impl
{
	...
	// NOTES
	class ValueListImpl
		: public Candidate::ValueList
	{
	public:
		typedef Candidate::ValueList Super;
		typedef ValueListImpl This;

		// constructor
		ValueListImpl(Relation::ValueList* pRelation_)
			: Super(),
	...
	// Interface::ICandidate::
		...
		Relation::ValueList* m_pRelation;
	};
...
#endif // __SYDNEY_PLAN_CANDIDATE_IMPL_VALUELISTIMPL_H
