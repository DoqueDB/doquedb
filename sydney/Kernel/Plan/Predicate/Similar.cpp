...
////////////////////////////////////
//	Plan::Predicate::Similar

// FUNCTION public
//	Predicate::Similar::create -- constructor
//
// NOTES
//
// ARGUMENTS
...
create(Opt::Environment& cEnvironment_,
	   ...
	   bool bIsNot_)
{
	AUTOPOINTER<This> pResult = new Impl::SimilarImpl(cOperand_, bIsNot_);
	pResult->registerToEnvironment(cEnvironment_);
	return pResult.release();
}

// FUNCTION protected
//	Predicate::Similar::Similar -- constructor
//
// NOTES
//
// ARGUMENTS
