...
#if 0
#include "Analysis/XA_ForgetStatement.h"
#endif
...
XA_ForgetStatement::XA_ForgetStatement()
	: Object(ObjectType::XA_ForgetStatement,
			 f__end_index, Object::Undefine, true)
{}

//	FUNCTION public
//	Statement::XA_ForgetStatement::setIdentifier --
...
void
XA_ForgetStatement::setIdentifier(XA_Identifier* p)
{
	m_vecpElements[f_Identifier] = p;
}

//	FUNCTION public
//	Statement::XA_ForgetStatement::getIdentifier --
//		トランザクションブランチ識別子を得る
//
//	NOTES
//
...
XA_Identifier*
XA_ForgetStatement::getIdentifier() const
{
...
namespace
{
	Analysis::XA_ForgetStatement _analyzer;
}

// Analyzerを得る
// virtual
const Analysis::Analyzer*
XA_ForgetStatement::getAnalyzer() const
{
	return &_analyzer;
}
#endif
