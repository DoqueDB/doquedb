...
#if 0
#include "Analysis/XA_EndStatement.h"
#endif
...
XA_EndStatement::XA_EndStatement()
	: Object(ObjectType::XA_EndStatement, f__end_index),
	  _suspensionMode(XA_EndStatement::SuspensionMode::Unknown)
{}

//	FUNCTION public
//	Statement::XA_EndStatement::setIdentifier --
...
void
XA_EndStatement::setIdentifier(XA_Identifier* p)
{
	m_vecpElements[f_Identifier] = p;
}

//	FUNCTION public
//	Statement::XA_EndStatement::getIdentifier --
//		トランザクションブランチ識別子を得る
//
//	NOTES
//
...
XA_Identifier*
XA_EndStatement::getIdentifier() const
{
...
namespace
{
	Analysis::XA_EndStatement _analyzer;
}

// Analyzerを得る
// virtual
const Analysis::Analyzer*
XA_EndStatement::getAnalyzer() const
{
	return &_analyzer;
}
#endif
