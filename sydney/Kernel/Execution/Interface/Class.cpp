...
namespace
{
	...
	//
	// NOTES
	const int _iSubModule = Externalizable::SubModule::Interface;
}

// FUNCTION public
//	Interface::Class::getClassInstance -- get instance from classid
//
// NOTES
//
// ARGUMENTS
...
getClassInstance(int iClassID_)
{
	...
	switch ( eCategory ) {
	case Category::IProgram:
		{
			pObject = IProgram::create();
			break;
		}
	default:
		{
...
// FUNCTION public
//	Interface::Class::getClassID -- get classid
//
// NOTES
//
// ARGUMENTS
