...
#ifndef __SYDNEY_EXECUTION_CONTROL_CLASS_H
#define __SYDNEY_EXECUTION_CONTROL_CLASS_H
...
// CLASS
//	Execution::Control::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	Execution::Control::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_EXECUTION_CONTROL_CLASS_H
