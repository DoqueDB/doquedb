...
// vi:set ts=4 sw=4:
//
// Execution/Operator/FileFetch.h --
// 
...
#ifndef __SYDNEY_EXECUTION_OPERATOR_FILEFETCH_H
#define __SYDNEY_EXECUTION_OPERATOR_FILEFETCH_H
...
////////////////////////////////////////////////////////////////////////////////
//	CLASS
//	Execution::Operator::FileFetch -- operator class for fetching file
//
//	NOTES
...
public:
	...
	// set output data ID
	virtual void setOutput(int iDataID_) = 0;
...
#endif // __SYDNEY_EXECUTION_OPERATOR_FILEFETCH_H
