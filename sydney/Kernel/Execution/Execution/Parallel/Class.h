...
#ifndef __SYDNEY_EXECUTION_PARALLEL_CLASS_H
#define __SYDNEY_EXECUTION_PARALLEL_CLASS_H
...
// CLASS
//	Execution::Parallel::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	Execution::Parallel::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_EXECUTION_PARALLEL_CLASS_H
