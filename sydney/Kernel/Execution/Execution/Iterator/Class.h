...
#ifndef __SYDNEY_EXECUTION_ITERATOR_CLASS_H
#define __SYDNEY_EXECUTION_ITERATOR_CLASS_H
...
// CLASS
//	Execution::Iterator::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	Execution::Iterator::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_EXECUTION_ITERATOR_CLASS_H
