...
#ifndef __SYDNEY_EXECUTION_INTERFACE_CLASS_H
#define __SYDNEY_EXECUTION_INTERFACE_CLASS_H
...
// CLASS
//	Execution::Interface::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	Execution::Interface::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_EXECUTION_INTERFACE_CLASS_H
