...
#ifndef __SYDNEY_EXECUTION_FUNCTION_CLASS_H
#define __SYDNEY_EXECUTION_FUNCTION_CLASS_H
...
// CLASS
//	Execution::Function::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	Execution::Function::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_EXECUTION_FUNCTION_CLASS_H
