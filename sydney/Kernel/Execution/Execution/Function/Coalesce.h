...
#ifndef __SYDNEY_EXECUTION_FUNCTION_COALESCE_H
#define __SYDNEY_EXECUTION_FUNCTION_COALESCE_H
...
////////////////////////////////////////////////////////////////////////////////
//	CLASS
//	Execution::Function::Coalesce -- function class for coalesce data
//
//	NOTES
...
public:
	...
	struct Default
	{
		// constructor -- coalese by isDefault
		static This* create(Interface::IProgram& cProgram_,
							Interface::IIterator* pIterator_,
							int iInDataID0_,
							int iInDataID1_,
...
#endif // __SYDNEY_EXECUTION_FUNCTION_COALESCE_H
