...
#ifndef __SYDNEY_EXECUTION_ACTION_CLASS_H
#define __SYDNEY_EXECUTION_ACTION_CLASS_H
...
// CLASS
//	Execution::Action::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	Execution::Action::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_EXECUTION_ACTION_CLASS_H
