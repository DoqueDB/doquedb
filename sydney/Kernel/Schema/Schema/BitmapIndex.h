...
// vi:set ts=4 sw=4:
//
// BitmapIndex.h -- bitmap索引オブジェクト関連のクラス定義、関数宣言
// 
// Copyright (c) 2005, 2015, 2023 Ricoh Company, Ltd.
// 
...
#ifndef	__SYDNEY_SCHEMA_BITMAPINDEX_H
#define	__SYDNEY_SCHEMA_BITMAPINDEX_H
...
//	CLASS
//	Schema::BitmapIndex -- bitmapインデックスオブジェクトを表すクラス
//
//	NOTES
...
#endif	// __SYDNEY_SCHEMA_BITMAPINDEX_H
