...
// vi:set ts=4 sw=4:
//
// FullTextIndex.h -- 全文索引オブジェクト関連のクラス定義、関数宣言
// 
// Copyright (c) 2002, 2015, 2023 Ricoh Company, Ltd.
// 
...
#ifndef	__SYDNEY_SCHEMA_FULLTEXTINDEX_H
#define	__SYDNEY_SCHEMA_FULLTEXTINDEX_H
...
//	CLASS
//	Schema::FullTextIndex -- 全文インデックスオブジェクトを表すクラス
//
//	NOTES
...
public:
	...
	FullTextIndex(const Database& database, Table& table, const Constraint& cConstraint_);
...
protected:
	// 索引のキーオブジェクトを生成する
	void					createKey(Trans::Transaction& cTrans_,
									  Table& cTable_,
...
#endif	// __SYDNEY_SCHEMA_FULLTEXTINDEX_H
