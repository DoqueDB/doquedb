...
// vi:set ts=4 sw=4:
//
// BtreeIndex.h -- B+木索引オブジェクト関連のクラス定義、関数宣言
// 
...
#ifndef	__SYDNEY_SCHEMA_BTREEINDEX_H
#define	__SYDNEY_SCHEMA_BTREEINDEX_H
...
//	CLASS
//	Schema::BtreeIndex -- B+木インデックスオブジェクトを表すクラス
//
//	NOTES
...
public:
	...
	BtreeIndex(const Database& database, Table& table, const Constraint& cConstraint_);
...
#endif	// __SYDNEY_SCHEMA_BTREEINDEX_H
