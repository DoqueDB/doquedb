...
// vi:set ts=4 sw=4:
//
// KdTreeIndex.h -- KdTree索引オブジェクト関連のクラス定義、関数宣言
// 
...
#ifndef	__SYDNEY_SCHEMA_KDTREEINDEX_H
#define	__SYDNEY_SCHEMA_KDTREEINDEX_H
...
//	CLASS
//	Schema::KdTreeIndex -- KdTreeインデックスオブジェクトを表すクラス
//
//	NOTES
...
#endif	// __SYDNEY_SCHEMA_KDTREEINDEX_H
