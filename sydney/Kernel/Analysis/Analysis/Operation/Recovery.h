...
#ifndef __SYDNEY_ANALYSIS_OPERATION_RECOVERY_H
#define __SYDNEY_ANALYSIS_OPERATION_RECOVERY_H
...
{
public:
	typedef Recovery This;
	typedef Interface::IAnalyzer Super;

	// constructor
	static const This* create(int iType_,
							  bool bIsRollback_);
	// destructor
	virtual ~Recovery() {}

	// generate relation for recovery
...
#endif // __SYDNEY_ANALYSIS_OPERATION_RECOVERY_H
