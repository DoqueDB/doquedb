...
#ifndef __SYDNEY_DEXECUTION_PREDICATE_CLASS_H
#define __SYDNEY_DEXECUTION_PREDICATE_CLASS_H
...
// CLASS
//	DExecution::Predicate::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	DExecution::Predicate::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_DEXECUTION_PREDICATE_CLASS_H
