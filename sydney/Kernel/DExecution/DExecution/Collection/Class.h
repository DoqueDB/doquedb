...
#ifndef __SYDNEY_DEXECUTION_COLLECTION_CLASS_H
#define __SYDNEY_DEXECUTION_COLLECTION_CLASS_H
...
// CLASS
//	DExecution::Collection::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	DExecution::Collection::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_DEXECUTION_COLLECTION_CLASS_H
