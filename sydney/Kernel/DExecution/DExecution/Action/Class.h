...
#ifndef __SYDNEY_DEXECUTION_ACTION_CLASS_H
#define __SYDNEY_DEXECUTION_ACTION_CLASS_H
...
// CLASS
//	DExecution::Action::Class -- static class for serialize-related functions
//
// NOTES
class Class
{
public:
	// ENUM
	//	DExecution::Action::Class::Category::Value --
	//
	// NOTES
...
#endif //__SYDNEY_DEXECUTION_ACTION_CLASS_H
