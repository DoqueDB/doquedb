...
echo "難破船 のlike検索" ; echo $value | tr '{},' '\n\n '
echo ;
...
echo "難破船, 無人島, 太平洋, 漂流 のlike検索(OR)" ; echo $value | tr '{},' '\n\n '
echo ;
...
from AozoraBunko
where content like '%難破船%' escape '!'
and content like '%無人島%' escape '!'
and content like '%太平洋%' escape '!'
and content like '%漂流%' escape '!'
limit 5"
value=`$sqli_cmd -sql $query`
echo "難破船, 無人島, 太平洋, 漂流 のlike検索(AND)" ; echo $value | tr '{},' '\n\n '
echo ;
