...
class NormalizedOkapiTfIdf : public TRMExternalScoreCalculator
{
private:
	// constant
	double k;
...
public:
	NormalizedOkapiTfIdf(const char* pParameter_);
...
{
	return (void*)new NormalizedOkapiTfIdf(parameter_);
}
...
NormalizedOkapiTfIdf::NormalizedOkapiTfIdf(const char *paramter_)
{
...
double NormalizedOkapiTfIdf::tfTerm(const TRMeisterScoreParameterValue *varParam)
{
...
double NormalizedOkapiTfIdf::dfTerm(const TRMeisterScoreParameterValue *varParam)
{
