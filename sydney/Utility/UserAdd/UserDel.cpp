...
{
#ifdef SYD_OS_WINDOWS
	cout << "Usage: userdel /remote hostname portnumber [options]"									<< endl;
	cout << ""																						<< endl;
	...
	cout << "   /username delusername           set delete user name."								<< endl;
	cout << "   /revoke                         the authority of all DB is deleted automatically."	<< endl;
	...
	try
	{
		...
		try
		{
			...
			try
			{
				...
				pExec = new ExecDel(*pDataSource, cOption);
