...
const char moduleName[] = "UserPassword";
}
...
{
#ifdef SYD_OS_WINDOWS
	cout << "Usage: userpassword /remote hostname portnumber [options]"					<< endl;
	cout << ""																			<< endl;
	cout << "where options include:"													<< endl;
	cout << "   /user username                  set user name."                         << endl;
	cout << "   /password password              set password for the user."             << endl;
	cout << "   /chusername chusername          set user name to change a password."	<< endl;
	...
	try
	{
		...
		try
		{
			...
			try
			{
				...
				pExec = new ExecPassword(*pDataSource, cOption);
