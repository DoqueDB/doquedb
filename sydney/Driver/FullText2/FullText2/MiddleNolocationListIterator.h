...
#ifndef __SYDNEY_FULLTEXT2_MIDDLENOLOCATIONLISTITERATOR_H
#define __SYDNEY_FULLTEXT2_MIDDLENOLOCATIONLISTITERATOR_H
...
public:
	// コンストラクタ
	MiddleNolocationListIterator(MiddleNolocationList& cMiddleList_);
	// デストラクタ
...
#endif //__SYDNEY_FULLTEXT2_MIDDLENOLOCATIONLISTITERATOR_H
