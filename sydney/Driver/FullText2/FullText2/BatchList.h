...
#ifndef __SYDNEY_FULLTEXT2_BATCHLIST_H
#define __SYDNEY_FULLTEXT2_BATCHLIST_H
...
public:
	// コンストラクタ(1)
	BatchList(InvertedUpdateFile& cInvertedFile_,
...
#endif //__SYDNEY_FULLTEXT2_BATCHLIST_H
