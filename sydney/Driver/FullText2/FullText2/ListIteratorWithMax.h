...
#ifndef __SYDNEY_FULLTEXT2_LISTITERATORWITHMAX_H
#define __SYDNEY_FULLTEXT2_LISTITERATORWITHMAX_H
...
//
//	CLASS
//	FullText2::ListIteratorWithMax --
//
//	NOTES
//
//
class ListIteratorWithMax : public ListIterator
{
public:
	//コンストラクタ
	ListIteratorWithMax(ListIterator* pListIterator_,
						DocumentID uiMaxDocumentID_);
	//デストラクタ
	virtual ~ListIteratorWithMax();
...
private:
	...
	// 現在の文書ID
	DocumentID m_uiCurrentDocumentID;
};

_SYDNEY_FULLTEXT2_END
_SYDNEY_END

#endif //__SYDNEY_FULLTEXT2_LISTITERATORWITHMAX_H
