...
// vi:set ts=4 sw=4:
//
// SimpleWordLeafLocationListItertor.h --
// 
...
#ifndef __SYDNEY_FULLTEXT2_SIMPLEWORDLEAFLOCATIONLISTITERATOR_H
#define __SYDNEY_FULLTEXT2_SIMPLEWORDLEAFLOCATIONLISTITERATOR_H
...
//	NOTES
//
class SimpleWordLeafLocationListIterator : public WordLeafLocationListIterator
{
public:
	// コンストラクタ
	...
	// デストラクタ
	virtual ~SimpleWordLeafLocationListIterator();
...
#endif //__SYDNEY_FULLTEXT2_SIMPLEWORDLEAFLOCATIONLISTITERATOR_H
