...
// vi:set ts=4 sw=4:
//
// NormalLeafLocationListItertor.h --
// 
...
#ifndef __SYDNEY_FULLTEXT2_NORMALLEAFLOCATIONLISTITERATOR_H
#define __SYDNEY_FULLTEXT2_NORMALLEAFLOCATIONLISTITERATOR_H
...
//	NOTES
//
class NormalLeafLocationListIterator : public LocationListIterator
{
	friend class NormalLeafNode;
...
public:
	...
	NormalLeafLocationListIterator(NormalLeafNode& cNode_,
								   ModSize reserve_);
	// デストラクタ
	virtual ~NormalLeafLocationListIterator();
	...
	// 位置情報へのイテレータを追加する
	void pushBack(ModSize pos, LocationListIterator::AutoPointer i);

private:
	typedef ModPair<ModSize, LocationListIterator::AutoPointer>	LocationPair;
...
#endif //__SYDNEY_FULLTEXT2_NORMALLEAFLOCATIONLISTITERATOR_H
