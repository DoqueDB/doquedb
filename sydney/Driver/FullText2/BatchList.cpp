...
//
//	FUNCTION public
//	FullText2::BatchList::BatchList -- コンストラクタ(1)
//
//	NOTES
//
//	ARGUMENTS
...
//	なし
//
BatchList::BatchList(InvertedUpdateFile& cInvertedFile_,
...
//
//	FUNCTION public
//	FullText2::BatchList::BatchList -- コンストラクタ(2)
//
//	NOTES
//
//	ARGUMENTS
//	FullText2::InvertedUpdateFile& cInvertedUpdateFile_
//		転置ファイル
...
//
//	FUNCTION public
//	FullText2::BatchList::~BatchList -- デストラクタ
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	FullText2::BatchList::insert -- 転置リストの挿入(1文書挿入用)
//
//	NOTES
//
//	ARGUMENTS
...
//
bool
BatchList::insert(ModUInt32 uiDocumentID_,
				  const SmartLocationList& cLocationList_)
{
	//
	//	必要なユニット数を求める
	...
	ModSize totalLength = m_pArea->getDocumentOffset() + idLength
							+ m_pArea->getLocationOffset() + locLength;
	...
	{
		// 位置情報ビットオフセット
		ModSize offset = m_pArea->getLocationOffset();
		// 圧縮して格納する
		writeLocationList(cLocationList_, bitLength,
						  m_pArea->getHeadAddress(), offset);
		// 位置情報ビットオフセットを設定する
		m_pArea->setLocationOffset(offset);
	}
...
//
//	FUNCTION public
//	FullText2::BatchList::getIterator -- イテレータを得る
//
//	NOTES
//
//	ARGUMENTS
