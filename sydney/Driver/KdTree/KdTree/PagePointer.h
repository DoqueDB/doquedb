...
#ifndef __SYDNEY_KDTREE_PAGEPOINTER_H
#define __SYDNEY_KDTREE_PAGEPOINTER_H
...
public:
	...
	bool operator == (int i)
		{ return get() == syd_reinterpret_cast<PAGE*>(i); }
	bool operator == (PAGE* pPage_)
		{ return get() == pPage_; }
...
private:
	...
	void decrement()
	{
		if (m_pPage) m_pPage->decrementReference();
	}
...
#endif //__SYDNEY_KDTREE_PAGEPOINTER_H
