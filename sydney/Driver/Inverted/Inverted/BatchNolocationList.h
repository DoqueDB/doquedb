...
#ifndef __SYDNEY_INVERTED_BATCHNOLOCATIONLIST_H
#define __SYDNEY_INVERTED_BATCHNOLOCATIONLIST_H
...
//
//	CLASS
//	Inverted::BatchNolocationList --
//
//	NOTES
//
//
class BatchNolocationList : public BatchBaseList
{
public:
	// コンストラクタ(1)
	BatchNolocationList(InvertedUnit& cInvertedUnit_,
			  BatchListMap& cBatchListMap_,
			  const ModUnicodeChar* pszKey_);
	// コンストラクタ(2)
	BatchNolocationList(InvertedUnit& cInvertedUnit_, LeafPage::Area* pArea_);
	// デストラクタ
	virtual ~BatchNolocationList();
...
#endif //__SYDNEY_INVERTED_BATCHNOLOCATIONLIST_H
