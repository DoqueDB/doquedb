...
#ifndef __SYDNEY_INVERTED_OPTIONDATAFILE_H
#define __SYDNEY_INVERTED_OPTIONDATAFILE_H
...
//
//	CLASS
//	Inverted::OptionDataFile -- オプションデータを取得するファイル
//
//	NOTES
//
...
#endif //__SYDNEY_INVERTED_OPTIONDATAFILE_H
