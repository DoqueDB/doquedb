...
namespace 
{
	...
	//	先頭ロックブロックの先頭位置
	//
	const unsigned short _START_LOCBLOCK_OFFSET = sizeof(OverflowPage::LocHeader)/sizeof(ModUInt32) + 1;
}

//
//	FUNCTION public
//	Inverted::OverflowPage::IDBlock::Header::getFirstDocumentID
//		-- 先頭文書IDを得る
//
//	NOTES
//
...
//
//	FUNCTION public
//	Inverted::OverflowPage::IDBlock::Header::setLocBlockOffset
//		-- LOCブロックのオフセットを設定する
//
//	NOTES
//
...
//
void
OverflowPage::IDBlock::Header::setLocBlockOffset(unsigned short usLocBlockOffset_)
{
...
//
//	FUNCTION public
//	Inverted::OverflowPage::IDBlock::Header::isExpunge
//		-- 削除されたか
//
//	NOTES
//
...
//
//	FUNCTION public
//	Inverted::OverflowPage::IDBlock::Header::setExpunge
//		-- 削除フラグを設定する
//
//	NOTES
//
...
//
//	FUNCTION public
//	Inverted::OverflowPage::LocBlock::isContinue -- 次のブロックに続くかどうか
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::LocBlock::getDataUnitSize -- データ部のユニット長を得る
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::LocBlock::getDataBitLength -- データ部のビット長を得る
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::LocBlock::setDataBitLength -- データ部のビット長を設定する
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::LocBlock::expandUnitSize -- ユニット数を増やす
//
//	NOTES
...
OverflowPage::LocBlock::expandUnitSize(ModSize iUnitSize_)
{
	...
	ModOsDriver::Memory::reset(getBuffer() + iSize, iUnitSize_*sizeof(ModUInt32));
...
//
//	FUNCTION public
//	Inverted::OverflowPage::LocBlock::expandBitLength -- 使用ビット長を増減させる
//
//	NOTES
...
//
//	FUNCTION public
//	Inverted::OverflowPage::LocBlock::setContinueFlag
//		-- 次のブロックにつづくブロックに設定する
//
//	NOTES
//
...
//
//	FUNCTION public
//	Inverted::OverflowPage::LocBlock::unsetContinueFlag
//		-- 次につづくブロックのフラグをクリアする
//
//	NOTES
//
...
//
//	FUNCTION public
//	Inverted::OverflowPage::OverflowPage -- コンストラクタ(1)
//
//	NOTES
//
//	ARGUMENTS
//	Inverted::OverflowFile& cFile_
//		オーバーフローファイル
...
//
//	FUNCTION public
//	Inverted::OverflowPage::OverflowPage -- コンストラクタ(2)
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::OverflowPage -- コンストラクタ(3)
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::OverflowPage -- コンストラクタ(4)
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::~OverflowPage -- デストラクタ
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::reset -- 初期化する
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::reset2 -- リセットする
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::setType -- ページ種別を設定する
//
//	NOTES
//
//	ARGUMENTS
//	Inverted::OverflowPage::Type::Value eType_
//		ページ種別
//
//	RETURN
//	なし
...
//
//	FUNCTION public
//	Inverted::OverflowPage::allocateIDBlock -- 新しいIDブロックを確保する
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::freeIDBlock -- 指定した位置のIDブロックを削除する
//
//	NOTES
//
//	ARGUMENTS
...
OverflowPage::freeIDBlock(ModSize uiPosition_)
{
	...
	{
		ModSize size = getIDBlockSize() * (getIDBlockCount() - uiPosition_ - 1) * sizeof(ModUInt32);
...
//
//	FUNCTION public
//	Inverted::OverflowPage::getIDBlock -- 指定した位置のIDブロックを得る
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::lowerBoundIDBlock
...
//	RETURN
//	Inverted::OverflowPage::IDBlock
//		検索でヒットしたIDブロック。すべて削除されている場合はinvalidなIDブロック
//
//	EXCEPTIONS
//
OverflowPage::IDBlock
OverflowPage::lowerBoundIDBlock(ModUInt32 uiDocumentID_, ModSize& uiPosition_, bool bUndo_)
{
...
//
//	FUNCTION public
//	Inverted::OverflowPage::moveIDBlock
...
//
//	ARGUMENTS
//	Inverted::OverflowPage::PagePointer pIdPage_
//		供給元のページ
//
//	RETURN
//	なし
...
//
//	FUNCTION public
//	Inverted::OverflowPage::getPrevDocumentID -- 直前のIDブロックの文書IDを得る
//
//	NOTES
//
//	ARGUMENTS
...
//	RETURN
//	ModUInt32
//		直前のIDブロックの文書ID。直前のブロックが存在しない場合はUndefinedDocumentID
//
//	EXCEPTIONS
//
ModUInt32
...
//
//	FUNCTION public
//	Inverted::OverflowPage::getNextDocumentID -- 直後のIDブロックの文書IDを得る
//
//	NOTES
//
//	ARGUMENTS
...
//	RETURN
//	ModUInt32
//		直後のIDブロックの文書ID。直後のブロックが存在しない場合はUndefinedDocumentID
//
//	EXCEPTIONS
//
ModUInt32
...
//
//	FUNCTION public
//	Inverted::OverflowPage::setPrevPageID -- 前方のページIDを設定する
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::setNextPageID -- 後方のページIDを設定する
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::allocateLocBlock -- 新しくロックブロックを確保する
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::freeLocBlock -- LOCブロックを1つ開放する
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::getLocBlock -- LOCブロックを得る
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::getLocBlock -- 先頭のLOCブロックを得る
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::addUsedUnitSize -- 使用ユニット数を増加させる
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION public
//	Inverted::OverflowPage::getUsedUnitSize -- 使用ユニット数を得る
//
//	NOTES
//
//	ARGUMENTS
...
OverflowPage::getUsedUnitSize() const
{
	...
	if (m_eType & Type::LOC)
	{
		...
		else
		{
			...
			// 最後のブロックを得る
			LocBlock cLast(const_cast<OverflowPage*>(this), m_pLocHeader->m_usOffset, p);

			// ユニット数を得る
			ModSize uiUnitSize = cLast.getUnitSize();

			// 使用しているユニット数は、最後のブロックのオフセット値+ユニット数である
...
//
//	FUNCTION public
//	Inverted::OverflowPage::enterDeleteIdBlock -- 削除ずみのIDブロックを登録する
//
//	NOTES
//
//	ARGUMENTS
...
//
bool
OverflowPage::enterDeleteIdBlock(InvertedList& cInvertedList_)
{
	bool result = true;
	...
	{
		if ((*i)->isExpunge())
			cInvertedList_.enterDeleteIdBlock((*i)->getFirstDocumentID());
		else
			result = false;
	}
	return result;
...
//
//	FUNCTION private
//	Inverted::OverflowPage::readType -- ページ種別を読む
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION private
//	Inverted::OverflowPage::loadIDHeader -- ID情報を読み込む
//
//	NOTES
//
//	ARGUMENTS
...
{
	// ページの最後に移動する
	ModUInt32* p = getBuffer() + getPageUnitSize() - sizeof(IDHeader)/sizeof(ModUInt32);
	// ヘッダーを設定する
...
//
//	FUNCTION public
//	Inverted::OverflowPage::loadIDData -- ID情報を読み込む
//
//	NOTES
//
//	ARGUMENTS
...
//
//	FUNCTION private
//	Inverted::OverflowPage::loadLocHeader -- LOCヘッダーを設定する
//
//	NOTES
//
//	ARGUMENTS
