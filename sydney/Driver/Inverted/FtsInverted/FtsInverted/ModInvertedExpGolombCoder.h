...
//
class
ModInvertedExpGolombCoder : public ModInvertedCoder
{
...
//
// FUNCTION
// ModInvertedExpGolombCoder::duplicate -- 複製の生成
//
// NOTES
// 自分の複製を生成する。
//
...
ModInvertedExpGolombCoder::duplicate() const
{
...
//
// FUNCTION
// ModInvertedExpGolombCoder::getDescription -- 符合器記述の取得
//
// NOTES
// 符合器記述を取得する。
//
...
//
inline void
ModInvertedExpGolombCoder::getDescription(ModCharString& description_) const
{
