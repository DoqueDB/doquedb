...
#ifndef __SYDNEY_BTREE2_VECTOR_H
#define __SYDNEY_BTREE2_VECTOR_H
...
//
//	TEMPLATE CLASS
//	Btree2::ReverseIterator -- nullビットマップ用ベクターのiterator
//
//	NOTES
//
template <class TYPE>
...
public:
	...
	{
		return static_cast<int>(i_._current - _current);
	}
...
//
//	TEMPLATE CLASS
//	Btree2::Vector -- nullビットマップ用のベクター
//
//	NOTES
...
#endif //__SYDNEY_BTREE2_VECTOR_H
